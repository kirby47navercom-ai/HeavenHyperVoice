...
inline constexpr SpeciesBase kSpecies[] = {
    ...
    // 아래는 뒤에 붙인 것이라 가나다 순이 위와 이어지지 않는다. id 가 DB 에
    // 그대로 저장되므로 중간에 끼워 넣을 수 없다.
    {21,  722, "나몰빼미",   68,  55,  55,  50,  50,  42},
    {22,  906, "나오하",     40,  61,  54,  45,  45,  65},
    {23,  744, "암멍이",     45,  65,  40,  30,  40,  60},
    {24,  734, "영구스",     48,  70,  30,  30,  30,  45},
    {25,  548, "치릴리",     45,  35,  50,  70,  50,  30},
    {26,   48, "콘팡",       60,  55,  50,  40,  55,  45},

    // 불꽃/물 계열 한 벌. 앞 묶음과 마찬가지로 뒤에만 붙인다.
    {27,  657, "개굴반장",   54,  63,  52,  83,  56,  97},
    {28,  130, "갸라도스",   95, 125,  79,  60, 100,  81},
    {29,  195, "누오",       95,  85,  85,  65,  65,  35},
    {30,  693, "블로스터",   71,  73,  88, 120,  89,  59},
    {31,  256, "영치코",     60,  85,  60,  85,  60,  55},
    {32,   59, "윈디",       90, 110,  80, 100,  80,  95},
    {33,  663, "파이어로",   78,  81,  71,  74,  69, 126},
    {34,  323, "폭타",       70, 100,  70, 105,  75,  40},

    // 풀 계열.
    {35,  252, "나무지기",   40,  45,  35,  65,  55,  70},

    // 뽑기 후보. FieldServer/gacha/pools.txt 가 여기 있는 도감번호만 받는다.
    //
    // 로토무는 한 줄이다. 클라이언트에는 여섯 폼이 있지만 DB 로스터가 도감번호
    // 열쇠라(013) 폼을 구분해 저장할 수 없다. 여섯 폼이 전부 479 다.
    {36,  253, "나무돌이",    50,  65,  45,  85,  65,  95},
    {37,  286, "버섯모",      60, 130,  80,  60,  60,  70},
    {38,  460, "눈설왕",      90,  92,  75,  92,  85,  60},
    {39,  549, "드레디어",    70,  60,  75, 110,  75,  90},
    {40,   52, "나옹",        40,  45,  35,  40,  40,  90},
    {41,  206, "노고치",     100,  70,  70,  65,  65,  45},
    {42,  289, "게을킹",     150, 160, 100,  95,  65, 100},
    {43,  143, "잠만보",     160, 110,  65,  65, 110,  30},
    {44,  901, "붉은달다투곰", 113, 70, 120, 135,  65,  52},
    {45,  702, "데덴네",      67,  58,  57,  81,  67, 101},
    {46,  181, "전룡",        90,  75,  85, 115,  90,  55},
    {47,  479, "로토무",      50,  50,  77,  95,  77,  91},
};
