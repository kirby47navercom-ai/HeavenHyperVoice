...
namespace
{
    ...
    Options parseArgs(int argc, char** argv)
    {
        ...
        // 전달된 host 주소가 없으면 이 컴퓨터 ip 주소를 찾아서 입력한다.
    ...
    // 분산된 서버를 시작해 준다.
    Server startServer(const std::filesystem::path& exe, const std::string& commandLine, const std::string& name)
    {
