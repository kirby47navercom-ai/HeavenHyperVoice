 ...
 * ServerGround/ServerWall components are exported by HHVCoreCollisionExport.
 */
...
class HEAVENHYPERVOICE_API AUEGoldenrodCity : public AActor
{
  ...
  public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Goldenrod|Boundary Camera",
	          meta = (ClampMin = "1"))
